...
class Reservations(models.Model):
    ...
    event_by=models.ForeignKey(Users,related_name="reserves")
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
    objects=ValidationManager()
...
class Orders(models.Model):
    ...
    order_by=models.ForeignKey(Users,related_name="orders")
    event=models.ForeignKey(Reservations,related_name="orders")
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
    objects=ValidationManager()
...
class Reviews(models.Model):
    ...
    review_by=models.ForeignKey(Users,related_name="my_reviews")
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
    objects=ValidationManager()
...
class Comments(models.Model):
    ...
    comment_by=models.ForeignKey(Users,related_name="my_comments")
    comment_in=models.ForeignKey(Reviews,related_name="the_comments")
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
    objects=ValidationManager()
